<div class="box"><!-- box Starts -->
    ...
    $temp_pro_price = str_replace( ',', '', $pro_price);

    $total_price = $total_price + ($temp_pro_price * $pro_qty);
    ...
    <center><!-- center Starts -->
        ...
        <form action="payment_only.php?price= <?php echo $total_price; ?>" method="post" target="_blank" style="margin-bottom: 30px;">
        ...
        <p class="lead text-center">
            ...
            <a href="order.php?c_id=<?php echo $customer_id; ?>">Place a  dummy order</a>
        ...
        <input type="image" name="submit" width="500" height="270" src="images/bkash_logo.png">
