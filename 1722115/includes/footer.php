<footer class="page-footer">
        ...
        <div class="container clearfix">
            ...
            <div class="footer-nav__col footer-nav__col--contacts">
                ...
                <address class="address">
                    Head Office: Nafees Shoes.<br>
                    180-182 Regent Street, Basundhara R/A, Dhaka.
                </address>
                <div class="phone">
                    Telephone:
                ...
                <div class="email">
                    Email:
                    <a href="mailto:support@yourwebsite.com" class="email__addr">support@nafeesshoes.com</a>
                </div>
            </div>
    ...
    <div class="page-footer__subline">
        <div class="container clearfix">
            ...
            <div class="copyright">
                &copy; 2018 Nafees Shoes&trade;
            </div>

            <div class="developer">
                Dev by Nafees Rahman Nizhum
            </div>

            <div class="designby">
                Design by Nafees Rahman Nizhum
            </div>
        </div>
    </div>
</footer>
