...
$men_query = "select cat_id from nafees_shoes.categories WHERE cat_title = 'Men'";
$run_men = mysqli_query($db, $men_query);
$row_men = mysqli_fetch_array($run_men);

$men_id = $row_men['cat_id'];

$get_products = "select * from nafees_shoes.products where cat_id = $men_id LIMIT $total_item OFFSET $end;";
