                        ...
                        <div class="table-responsive"><!-- table-responsive Starts -->
                            ...
                            <div class="form-inline pull-right"><!-- form-inline pull-right Starts -->
                                ...
                                <div class="form-group"><!-- form-group Starts -->
                                    ...
                                    <label style="margin-right: 2px">Coupon Code : </label>

                                    <input type="text" name="code" class="form-control" style="margin-right: 2px">
...
<a href='details.php?product=$pro_id' class='btn btn-default' >View Details</a>

<a href='details.php?product=$pro_id' class='btn btn-danger'>
